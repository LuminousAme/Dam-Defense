...
void LoadingScene::InitScene()
{
	...
	//main camera
	{
		...
		Get<TTN_Camera>(cam).CalcOrtho(0.0f, 1920.0f, 1080.0f, 0.0f, 0.1f, 100.0f);
	...
	//background
	{
		...
		TTN_Transform bgTrans = TTN_Transform(glm::vec3(960.0f, 540.0f, 50.0f), glm::vec3(0.0f), glm::vec3(1920.0f, 1080.0f, 1.0f));
		AttachCopy(bg, bgTrans);

		//create a sprite renderer for the background
		TTN_Renderer2D bgRenderer2D = TTN_Renderer2D(bgText);
	...
	//loading text
	{
		...
		TTN_Transform textTrans = TTN_Transform(glm::vec3(870.0f, 720.0f, 1.0f), glm::vec3(0.0f), glm::vec3(550.0f, 150.0f, 1.0f));
	...
	//loading cirlce
	{
		...
		//create a transform for the logo, placing it in the center of the screen, covering the whole thing
		TTN_Transform circleTrans = TTN_Transform(glm::vec3(1245.0f, 720.0f, 2.0f), glm::vec3(0.0f), glm::vec3(160.0f, 160.0f, 1.0f));
...
void LoadingScene::Update(float deltaTime)
{
	...
	Get<TTN_Transform>(loadingCircle).RotateFixed(glm::vec3(0.0f, 0.0f, 90.0f * deltaTime));
